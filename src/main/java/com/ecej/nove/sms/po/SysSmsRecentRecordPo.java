...
public class SysSmsRecentRecordPo implements Serializable {
	...
	// columns START
	/**
	 * recentRecordId db_column: recent_record_id
	 */
	private Integer recentRecordId;
	/**
	...
	public Integer getRecentRecordId() {
		return this.recentRecordId;
	}

	public void setRecentRecordId(Integer value) {
		this.recentRecordId = value;
	}
	...
	/**
	 * 转化为 SysSmsSendHistoryPo 对象
	 *
	 * @return
	 */
	public SysSmsSendHistoryPo convertToSysSmsSendHistoryPo() {
		SysSmsSendHistoryPo po = new SysSmsSendHistoryPo();
		BeanUtils.copyProperties(this, po, "recentRecordId");
		return po;
	}
