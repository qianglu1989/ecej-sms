...
public class SysSmsToSendPo implements Serializable {
	private static final long serialVersionUID = 1L;
	// alias
	public static final String TABLE_ALIAS = "SysSmsToSend";
	...
	/**
	 * 转化为 SysSmsRecentRecordPo 对象
	 *
	 * @return
	 */
	public SysSmsRecentRecordPo convertToSysSmsRecentRecordPo() {
		SysSmsRecentRecordPo po = new SysSmsRecentRecordPo();
		BeanUtils.copyProperties(this, po, "sendId");
		return po;
	}
