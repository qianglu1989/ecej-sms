...
public class PushSM {
	...
	static {
		SMS_BUSINESS_SERVICE_A = PropertyConfigUtils.getProperty("SMS_BUSINESS_SERVICE_A");
		SMS_BUSINESS_USERNAME_A = PropertyConfigUtils.getProperty("SMS_BUSINESS_USERNAME_A");
		SMS_BUSINESS_PASSWORD_A = PropertyConfigUtils.getProperty("SMS_BUSINESS_PASSWORD_A");

		SMS_BUSINESS_SERVICE_C = PropertyConfigUtils.getProperty("SMS_BUSINESS_SERVICE_C");
		SMS_BUSINESS_USERNAME_C = PropertyConfigUtils.getProperty("SMS_BUSINESS_USERNAME_C");
		SMS_BUSINESS_PASSWORD_C = PropertyConfigUtils.getProperty("SMS_BUSINESS_PASSWORD_C");

		SMS_MARKETING_SERVICE_A = PropertyConfigUtils.getProperty("SMS_MARKETING_SERVICE_A");
		SMS_MARKETING_USERNAME_A = PropertyConfigUtils.getProperty("SMS_MARKETING_USERNAME_A");
		SMS_MARKETING_PASSWORD_A = PropertyConfigUtils.getProperty("SMS_MARKETING_PASSWORD_A");

		SMS_MARKETING_SERVICE_C = PropertyConfigUtils.getProperty("SMS_MARKETING_SERVICE_C");
		SMS_MARKETING_USERNAME_C = PropertyConfigUtils.getProperty("SMS_MARKETING_USERNAME_C");
		SMS_MARKETING_PASSWORD_C = PropertyConfigUtils.getProperty("SMS_MARKETING_PASSWORD_C");

		SMS_EVALUATE_SERVICE_C = PropertyConfigUtils.getProperty("SMS_EVALUATE_SERVICE_C");
		SMS_EVALUATE_USERNAME_C = PropertyConfigUtils.getProperty("SMS_EVALUATE_USERNAME_C");
		SMS_EVALUATE_PASSWORD_C = PropertyConfigUtils.getProperty("SMS_EVALUATE_PASSWORD_C");

		SMS_VERIFICATION_SERVICE_A = PropertyConfigUtils.getProperty("SMS_VERIFICATION_SERVICE_A");
		SMS_VERIFICATION_USERNAME_A = PropertyConfigUtils.getProperty("SMS_VERIFICATION_USERNAME_A");
		SMS_VERIFICATION_PASSWORD_A = PropertyConfigUtils.getProperty("SMS_VERIFICATION_PASSWORD_A");

		SMS_VERIFICATION_SERVICE_B = PropertyConfigUtils.getProperty("SMS_VERIFICATION_SERVICE_B");
		SMS_VERIFICATION_USERNAME_B = PropertyConfigUtils.getProperty("SMS_VERIFICATION_USERNAME_B");
		SMS_VERIFICATION_PASSWORD_B = PropertyConfigUtils.getProperty("SMS_VERIFICATION_PASSWORD_B");
	}
	...
	public static boolean sendSMS(SMSMessage message) {
		...
		Map<String, Object> map =assemblyData(SMS_BUSINESS_USERNAME_A,SMS_BUSINESS_PASSWORD_A,message);
		try {
	...
	public static boolean sendSMS2(SMSMessage message) {
        ...
        Map<String, Object> map =assemblyData(SMS_BUSINESS_USERNAME_C,SMS_BUSINESS_PASSWORD_C,message);
	...
	public static boolean sendSMS3(SMSMessage message) {
		boolean flag = false;
        Map<String, Object> map =assemblyData(SMS_MARKETING_USERNAME_A,SMS_MARKETING_PASSWORD_A,message);
	...
	public static boolean sendSMS4(SMSMessage message) {
		boolean flag = false;
        Map<String, Object> map =assemblyData(SMS_MARKETING_USERNAME_C,SMS_MARKETING_PASSWORD_C,message);
     ...
     * @return
     */
	private static Map<String,Object> assemblyData(String username, String pwd, SMSMessage message){

		HashMap<String,Object> map = new HashMap<>();
		try {
			map.put("username", URLEncoder.encode(username, "utf-8"));
			map.put("password", URLEncoder.encode(MD5Util.MD5(pwd), "utf-8"));
